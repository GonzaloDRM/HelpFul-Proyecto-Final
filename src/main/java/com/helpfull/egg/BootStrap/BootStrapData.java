...
public class BootStrapData implements CommandLineRunner {
        ...
        try (InputStreamReader streamReader = new InputStreamReader(is, StandardCharsets.UTF_8);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                voluntario = new Voluntario(
                        ...
                        zonaRepository.buscarPorBarrio(line.split(",")[12]).get(0));
        ...
        try (InputStreamReader streamReader = new InputStreamReader(is, StandardCharsets.UTF_8);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                Voluntario administrador = new Voluntario(
                        ...
                        LocalDate.now(),
                        stringToCollectionInteresVoluntario(line.split(",")[11]),
                        zonaRepository.buscarPorDepartameto(line.split(",")[12]).get(0));
            ...
            while ((line = reader.readLine()) != null) {
                try {
                    ...
                    Amigo amigo = new Amigo(
                            ...
                            capitalizarPalabra(line.split(",")[4]),
                            LocalDate.now(),
                            leerContenidoFoto(line.split(",")[5], mimeType),
                            stringToCollectionInteres(line.split(",")[6]),
                            stringToCollectionDiscapacidad(line.split(",")[7]),
                            stringToCollectionNecesidad(line.split(",")[8]),
                            zonaRepository.buscarPorDepartameto(line.split(",")[9]).get(0));
    ...
    private Collection<Interes> stringToCollectionInteres(String string) {
        ...
        List<Interes> temp = Collections.<Interes>emptyList();
    ...
    private Collection<Necesidad> stringToCollectionNecesidad(String string) {
        ...
        List<Necesidad> temp = Collections.<Necesidad>emptyList();
    ...
    private Collection<Discapacidad> stringToCollectionDiscapacidad(String string) {
        ...
        List<Discapacidad> temp = Collections.<Discapacidad>emptyList();
